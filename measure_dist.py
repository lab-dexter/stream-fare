...
if __name__ == '__main__':     # Program start from here
    ...
    config.read('/home/pi/stream_fare/monitor.ini')
    ...
    parser.add_argument("trig_pin", type=int, help="Raspberry PI pin number for ultrasound sensor TRIG signal")
    parser.add_argument("echo_pin", type=int, help="Raspbeery PI pin number for ultrasound sensor ECHO signal")
    args = parser.parse_args()
    print args
    TRIG = args.trig_pin
    ECHO_PINS = {'1': args.echo_pin}
